...
const T={
  en:{
    ...
    'setup.apikey':'OpenAI API key (sk-…) for live mode — optional',
  ...
  ko:{
    ...
    'setup.apikey':'라이브 모드용 OpenAI API 키 (sk-…) — 선택',
...
// COMPANY + SCENARIOS are defined in src/scenarios.js (build concatenates it first).
